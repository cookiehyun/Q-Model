...
CONFIRMED best (threshold, strategy, model_type) per base model:
    ...
    Deep Ensemble  | thr=0.10 | Simple   | MLP
    MC Dropout     | thr=0.13 | CrossFit | MLP
    XGBoost        | thr=0.11 | CrossFit | LR
...
Outputs:
    ...
    qmodel_feature_importance_top5_4models_comparison.png  <- combined gain-importance bar chart (as before)
...
plot_combined(all_top5_gain,
              ...
              "(calibrated features, confirmed best threshold/strategy)",
...
plot_combined(all_top5_shap,
              ...
              "(calibrated features, confirmed best threshold/strategy)",
              "qmodel_shap_top5_4models_comparison.png")
